...
**Updated by:** Project Lead (added CLAUDE.md entry point)
...
1. **Content reset** — Cover redesign spec, new hook template, rebuild bio and CTA. Agents: Content Strategist, Reel Producer, Funnel Builder.
2. **Book rescue** — Full editorial pass, redesign without background image, reflow to KDP trim, new listing copy, cover brief. Agent: Book Publisher.
3. **Weekly metrics review** — Every Sunday: Analytics agent reviews last 7 days, updates this file, feeds Content Strategist.
4. **Course polish (paused)** — Revisit in 4–6 weeks once content is growing.
